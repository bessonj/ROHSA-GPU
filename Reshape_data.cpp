...
Reshape_data::Reshape_data(const Parse &file)
{
/*
	std::vector<int> kernel_slice(3,0.);

	kernel_slice.vector::push_back(0.);
	kernel_slice.vector::push_back(0.);
	kernel_slice.vector::push_back(0.);
	kernel.vector::push_back(vector);
*/
	...
	std::cout<<" texte de test "<<std::endl;
...
void Reshape_data::convolution_2D_mirror(const std::vector<std::vector<double>> &image, std::vector<std::vector<double>> &conv, int dim_y, int dim_x, const std::vector< std::vector< double >> &kernel, int dim_k)
{
...
void Reshape_data::ravel_2D(const std::vector<std::vector<double>> &map, std::vector<double> &vector, int dim_y, int dim_x)
{
	int i__(1);
...
void Reshape_data::ravel_3D(const std::vector<std::vector<std::vector<double>>> &cube, std::vector<double> &vector, int dim_v, int dim_y, int dim_x)
{
        int i__(1);
...
void Reshape_data::ravel_3D_abs(const std::vector<std::vector<std::vector<double>>> &cube, const std::vector<std::vector<std::vector<double>>> &cube_abs, std::vector<double> &vector, int dim_v, int dim_y, int dim_x)
{
        int i__(1);
...
void Reshape_data::unravel_3D(const std::vector<double> &vector, std::vector<std::vector<std::vector<double>>> &cube, int dim_v, int dim_y, int dim_x)
{
	int i__(1);
...
void Reshape_data::unravel_3D_abs(const std::vector<double> &vector, std::vector<std::vector<std::vector<double>>> &cube_abs,std::vector<std::vector<std::vector<double>>> &cube, int dim_v, int dim_y, int dim_x)
{
        int i__(1);
...
double Reshape_data::mean(const std::vector<double> &array)
{
...
double Reshape_data::Std(const std::vector<double> &array)
{
...
double Reshape_data::std_2D(const std::vector<std::vector<double>> &map, int dim_y, int dim_x)
{
...
double Reshape_data::max_2D(const std::vector<std::vector<double>> &map, int dim_y, int dim_x)
{
	std::vector<double> vector(dim_x*dim_y,0.);
	ravel_2D(map, vector, dim_y, dim_x);
...
double Reshape_data::mean_2D(const std::vector<std::vector<double>> &map, int dim_y, int dim_x)
{
...
/*
void Reshape_data::std_spectrum(std::vector<double> &spectrum, int dim_x, int dim_y, int dim_v)
{
...
/*
void Reshape_data::mean_spectrum(std::vector<double> &spectrum, int dim_v, int dim_y, int dim_x)
{
	std::vector<std::vector<double>> map(dim_x, std::vector<double>(dim_y,0.) );
