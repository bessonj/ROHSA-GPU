...
//    printf("\n\t Allocating and intializing memory");
    ...
    checkCudaErrors(cudaEventRecord(record_event[0], NULL));
        ...
        double* d_IMAGE;            cudaMalloc((void**)&d_IMAGE,    size_i);
        double* d_RESULTAT;        cudaMalloc((void**)&d_RESULTAT, size_i);
        double* d_RESULTAT_RESHAPED;        cudaMalloc((void**)&d_RESULTAT_RESHAPED, size_j);  
